...
function delete_account() {
    ...
    fetch(`/instructor/${instructorId}/delete_account`, {
        method: "PATCH",
        headers: {
...
function update_user_info(e) {
    ...
    const instructorId = window.location.pathname.split("/")[2];
    fetch(`/instructor/${instructorId}/update_info`, {
        method: "PATCH",
        headers: {
            "Content-Type": "application/json"
        },
...
function update_user_pwd(e) {
    ...
    const instructorId = window.location.pathname.split("/")[2];
    fetch(`/instructor/${instructorId}/update_pwd`, {
        method: "PATCH",
        headers: {
            "Content-Type": "application/json"
        },
        ...
        .then(response => {
            ...
            if (response.message) {
                ...
                document.querySelector(".right #message").style.border = "var(--border-width) solid red";
                document.querySelector(".right #message").style.color = "red";
                document.querySelector(".right #message").innerHTML = `<span>${response.error}</span>`;
            }
